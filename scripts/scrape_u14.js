...
const TARGET_URL = 'https://www.football.org.il/team-details/team-games/?team_id=5101&season_id=27';
// Correct URL/ID based on previous list_teams.js output: 
// 6: ילדים א - בית"ר חיפה 2 - https://www.football.org.il/team-details/?team_id=5101&season_id=27
const TEAM_ID_STR = 'team_id=5101';
const DB_PATH = path.join(__dirname, '../db.json');

async function scrapeU14() {
    console.log(`Starting U14 (Yeladim A) scrape...`);
    ...
    try {
        ...
        console.log(`Scraped ${games.length} games for U14.`);
        ...
        if (teamIndex !== -1) {
            ...
            console.log(`Database updated for U14 (Index ${teamIndex}).`);
        } else {
            console.error(`Team with ID 5101 not found in DB!`);
        }
