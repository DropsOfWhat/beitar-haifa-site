...
const TARGET_URL = 'https://www.football.org.il/team-details/team-games/?team_id=5659&season_id=27';
// Matches list_teams.js: 9: ילדים ג - בית"ר חיפה - https://www.football.org.il/team-details/?team_id=5659&season_id=27
const TEAM_ID_STR = 'team_id=5659';
const DB_PATH = path.join(__dirname, '../db.json');

async function scrapeU12() {
    console.log(`Starting U12 (Yeladim G) scrape...`);
    ...
    try {
        ...
        console.log(`Scraped ${games.length} games for U12.`);
        ...
        if (teamIndex !== -1) {
            ...
            console.log(`Database updated for U12 (Index ${teamIndex}).`);
        } else {
            console.error(`Team with ID 5659 not found in DB!`);
        }
