...
const TARGET_URL = 'https://www.football.org.il/team-details/team-games/?team_id=5957&season_id=27';
// Matches list_teams.js: 12: טרום ילדים ב - בית"ר חיפה - https://www.football.org.il/team-details/?team_id=5957&season_id=27
const TEAM_ID_STR = 'team_id=5957';
const DB_PATH = path.join(__dirname, '../db.json');

async function scrapeU10() {
    console.log(`Starting U10 (Trom Yeladim B) scrape...`);
    ...
    try {
        ...
        console.log(`Scraped ${games.length} games for U10.`);
        ...
        if (teamIndex !== -1) {
            ...
            console.log(`Database updated for U10 (Index ${teamIndex}).`);
        } else {
            console.error(`Team with ID 5957 not found in DB!`);
        }
