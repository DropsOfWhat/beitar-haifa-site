...
const TARGET_URL = 'https://www.football.org.il/team-details/team-games/?team_id=7680&season_id=27';
// Use the URL component as a more stable identifier if possible, or careful name matching.
// Based on list_teams.js output: 5: נערים ג - בית"ר חיפה - https://www.football.org.il/team-details/?team_id=7680&season_id=27
const TEAM_ID_STR = 'team_id=7680';
const DB_PATH = path.join(__dirname, '../db.json');

async function scrapeU15_2() {
    console.log(`Starting U15 (Naarim G - Beitar Haifa) scrape...`);
    ...
    try {
        ...
        // Note: User mentioned specifically to CLICK the 'Games' tab if entering the main team page.
        // However, the URL I constructed targets 'team-games' directly, which usually works better.
        // If this fails, I'll fallback to clicking.
        ...
        console.log(`Scraped ${games.length} games for U15 (Team 2).`);
        ...
        if (teamIndex !== -1) {
            ...
            console.log(`Database updated for U15_2 (Index ${teamIndex}).`);
        } else {
            console.error(`Team with ID 7680 not found in DB!`);
        }
