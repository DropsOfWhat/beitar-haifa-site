...
const TARGET_URL = 'https://www.football.org.il/team-details/team-games/?team_id=7487&season_id=27';
// Matches list_teams.js: 11: טרום ילדים א - ב.חיפה "צו פיוס" - https://www.football.org.il/team-details/?team_id=7487&season_id=27
const TEAM_ID_STR = 'team_id=7487';
const DB_PATH = path.join(__dirname, '../db.json');

async function scrapeU11_2() {
    console.log(`Starting U11 (Trom Yeladim A - Team 2 - Tzav Pius) scrape...`);
    ...
    try {
        ...
        const games = await page.evaluate(() => {
            ...
            rows.forEach(row => {
                ...
                if (matchCell) {
                    ...
                    if (parts.length >= 2) {
                        const isUs = (name) => name.includes('בית"ר חיפה') || name.includes('ב.חיפה');
        ...
        console.log(`Scraped ${games.length} games for U11 (Team 2).`);
        ...
        if (teamIndex !== -1) {
            ...
            console.log(`Database updated for U11_2 (Index ${teamIndex}).`);
        } else {
            console.error(`Team with ID 7487 not found in DB!`);
        }
