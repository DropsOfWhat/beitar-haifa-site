...
// We use the direct team-games URL for stability, as it avoids the need to click tabs.
const TARGET_URL = 'https://www.football.org.il/team-details/team-games/?team_id=5450&season_id=27';
const TEAM_ID_STR = 'team_id=5450';
const DB_PATH = path.join(__dirname, '../db.json');

async function scrapeU13() {
    console.log(`Starting U13 (Yeladim B) scrape...`);
    ...
    try {
        ...
        console.log(`Scraped ${games.length} games for U13.`);
        ...
        if (teamIndex !== -1) {
            ...
            console.log(`Database updated for U13 (Index ${teamIndex}).`);
        } else {
            console.error(`Team with ID 5450 not found in DB!`);
        }
