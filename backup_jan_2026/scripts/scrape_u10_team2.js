...
const TARGET_URL = 'https://www.football.org.il/team-details/team-games/?team_id=8299&season_id=27';
// Matches list_teams.js: 13: טרום ילדים ב - בית"ר חיפה יעקב 2 - https://www.football.org.il/team-details/?team_id=8299&season_id=27
const TEAM_ID_STR = 'team_id=8299';
const DB_PATH = path.join(__dirname, '../db.json');

async function scrapeU10_2() {
    console.log(`Starting U10 (Trom Yeladim B - Team 2) scrape...`);
    ...
    try {
        ...
        console.log(`Scraped ${games.length} games for U10 (Team 2).`);
        ...
        if (teamIndex !== -1) {
            ...
            console.log(`Database updated for U10_2 (Index ${teamIndex}).`);
        } else {
            console.error(`Team with ID 8299 not found in DB!`);
        }
