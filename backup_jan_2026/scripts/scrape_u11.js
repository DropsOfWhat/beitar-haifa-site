...
const TARGET_URL = 'https://www.football.org.il/team-details/team-games/?team_id=5339&season_id=27';
// Matches list_teams.js: 10: טרום ילדים א - בית"ר חיפה 2 - https://www.football.org.il/team-details/?team_id=5339&season_id=27
const TEAM_ID_STR = 'team_id=5339';
const DB_PATH = path.join(__dirname, '../db.json');

async function scrapeU11() {
    console.log(`Starting U11 (Trom Yeladim A) scrape...`);
    ...
    try {
        ...
        console.log(`Scraped ${games.length} games for U11.`);
        ...
        if (teamIndex !== -1) {
            ...
            console.log(`Database updated for U11 (Index ${teamIndex}).`);
        } else {
            console.error(`Team with ID 5339 not found in DB!`);
        }
